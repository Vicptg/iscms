<?php
	...
	if (
		file_exists($module -> path . DIRECTORY_SEPARATOR . 'data' . DIRECTORY_SEPARATOR . $module -> param . '_schedule.csv') &&
		filesize($module -> path . DIRECTORY_SEPARATOR . 'data' . DIRECTORY_SEPARATOR . $module -> param . '_schedule.csv') > 0
	) {
		
		$module -> settings -> schedule = dataloadcsv($module -> path . DIRECTORY_SEPARATOR . 'data' . DIRECTORY_SEPARATOR . $module -> param . '_schedule');
	...
	if (
		!file_exists($module -> path . DIRECTORY_SEPARATOR . 'data' . DIRECTORY_SEPARATOR . $module -> param . '.csv') ||
		filesize($module -> path . DIRECTORY_SEPARATOR . 'data' . DIRECTORY_SEPARATOR . $module -> param . '.csv') === 0
	) {
		file_put_contents($module -> path . DIRECTORY_SEPARATOR . 'data' . DIRECTORY_SEPARATOR . $module -> param . '.csv', 'absolute,' . $module -> settings -> date -> sort . ',email,contacts,"datetime order",status');
	}
	...
	if (
		...
		$module -> data = dataloadcsv($module -> path . DIRECTORY_SEPARATOR . 'data' . DIRECTORY_SEPARATOR . $module -> param);

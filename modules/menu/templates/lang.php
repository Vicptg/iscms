<?php defined('isCMS') or die;
	...
	require 'elements' . DIRECTORY_SEPARATOR . 'elements.php';
	...
	foreach ($template -> langs as $target) :
	
	$type === 'item';
	require 'elements' . DIRECTORY_SEPARATOR . 'link_open.php';
...
<?php
	...
	require 'elements' . DIRECTORY_SEPARATOR . 'link_inside.php';
	require 'elements' . DIRECTORY_SEPARATOR . 'link_close.php';
